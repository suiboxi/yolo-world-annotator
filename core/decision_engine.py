...
from core.verification import AUTO_ACCEPT, HUMAN_CONFIRMED, REJECT, REVIEW, SigLIPPrediction, classify_yolo_only
from models.vlm_verifier import MATCH, NOT_MATCH, UNCERTAIN, VLMResult, VLMTriggerPolicy
