...
from core.class_profiles import ClassProfiles, ensure_class_profiles
from core.yolo_format import load_yolo, serialize_yolo
from utils.config import DEFAULT_CONFIG, atomic_write_json, atomic_write_text, load_json
...
class DatasetProject:
    ...
    def save_metadata(self) -> None:
        ...
        from core.class_profiles import save_class_profiles
