...
from app.canvas import AnnotationCanvas, SegmentationPreview
from app.image_list import ImageListWidget
from app.inference_worker import InferenceWorker
from app.settings_panel import SettingsPanel
from app.statistics_dialog import StatisticsDialog
...
from core.evaluation import evaluate_ab as evaluate_ab_project, load_ground_truth
from core.benchmark import benchmark_project
from core.hard_samples import append_hard_sample, record_auto_issues
from core.history import HistoryManager
from core.statistics import collect_statistics
from core.verification import HUMAN_CONFIRMED, image_matches_filter
from utils.config import as_bool, atomic_write_text
from utils.image_utils import discover_images
...
class MainWindow(QMainWindow):
    ...
    def open_project(self, root: Path) -> None:
        try:
            ...
            # Importing a project is a complete setup action: load the chosen
            # detector/classes immediately so the next click can annotate.
            self.model_loaded = False
            self.load_model()
        except Exception as exc:
